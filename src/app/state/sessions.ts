...
const removeFallbackSession = () => {
  localStorage.removeItem('blackwall_hs_base_url');
  localStorage.removeItem('blackwall_user_id');
  localStorage.removeItem('blackwall_device_id');
  localStorage.removeItem('blackwall_access_token');
};
const getFallbackSession = (): Session | undefined => {
  const baseUrl = localStorage.getItem('blackwall_hs_base_url');
  const userId = localStorage.getItem('blackwall_user_id');
  const deviceId = localStorage.getItem('blackwall_device_id');
  const accessToken = localStorage.getItem('blackwall_access_token');
